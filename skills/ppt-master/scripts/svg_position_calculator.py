...
# Source of truth is project_utils.CANVAS_FORMATS (which itself tries config.py
# first, then falls back to a complete 8-format mirror). Local fallback copies
# here previously drifted from the canonical definition — see the v2.7.0 code
# quality report, finding "CANVAS_FORMATS duplication drift risk".
from project_utils import CANVAS_FORMATS  # noqa: F401  (re-exported for legacy callers)
